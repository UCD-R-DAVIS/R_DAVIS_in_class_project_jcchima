...
surveys <- read_csv("data/portal_data_joined.csv") %>%
  filter(complete.cases(.)) # remove all NA's. You can use "." as a relacement for the data you want to use in your function
...
ggplot(data = surveys_wt_cat, aes(reorder(x = weight_cat, mean(hindfoot_length)), y = hindfoot_length)) +
