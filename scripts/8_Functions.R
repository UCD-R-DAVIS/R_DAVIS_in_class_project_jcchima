...
## what happens in the function (the squiggly brackets), stays in the function
f_to_k <- function(tempF){
...
source("scripts/functions.R") #for running functions in another script that you might want to use in your current script
